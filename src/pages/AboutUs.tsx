            ...
            <Card>
              <CardContent sx={{ padding: 3 }}>
                ...
                <Typography
                  ...
                  sx={{ marginTop: 2 }}
                >
                  Sarkara Coffee merupakan sebuah startup kopi yang didirikan
                  pada tahun 2023. Kami percaya bahwa setiap cangkir kopi adalah
                  sebuah karya seni. Dengan menggabungkan biji kopi berkualitas
                  dengan teknik roasting yang unik, kami menciptakan cita rasa
                  yang tak terlupakan. Setiap menu kami memiliki cerita dan
                  karakternya masing-masing, siap untuk memanjakan lidah Anda.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
